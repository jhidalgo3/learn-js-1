define(['underscore','backbone','modelsTodo']
...
describe('About Backbone.Model', function() {
    ...
    it('Can be created with default values for its attributes.', function() {
        ...
        expect(todo.get('content')).toBe("empty todo...");
    });
    
    it('Will set passed attributes on the model instance when created.', function() {
        var todo = new Todo({ content: 'Get oil change for car.' });
        
        expect(todo.get('content')).toBe("Get oil change for car.");
    ...
    it('#17 Will call a custom initialize function on the model instance when created.', function() {
        var toot = new Todo({ content: 'Stop fire' });
        
        expect(toot.get('content')).toBe('Stop fire');
    });
